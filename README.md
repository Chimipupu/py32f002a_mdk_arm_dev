...
> ➡️ **未搭載のはずのPLLでx2の2逓倍固定だがHSI 24MHzを48MHzにできる**<br>
> ➡️ **未搭載のはずのDMAで転送もIRQ割り込みもできる**<br>
> ➡️ **未搭載のはずのRTCで1秒おきのカウントとIRQ割り込みもできる**<br>
...
| ROM | 20KB | **32KB** |
| RAM | 3KB | **4KB** |
| Clock | ・HSI 48MHz<br>※PLLは未搭載<br>・LSI 32KHz | **・HSI 48MHz<br>※PLLはx2の2逓倍固定<br>・LSI 32.768KHz** |
| GPIO | x18本 | x18本 |
| DMA | なし | **x3本** |
